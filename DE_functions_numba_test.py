# -*- coding: utf-8 -*-
"""
Created on Mon Dec 10 15:17:29 2018
...
from jDE_main_numba import jDE_main_numba as jDE_main_numba
...
def jDE(selectionParams,DE_par,NSeed,folders,formats,split_data,Sa_Tgt,Sa):
    ...
    while index<NSeed:
        ...
        #for cmb in range(split_end-split_start):
            ...
            P=jDE_main_numba(cmb,Sa_Tgt,formats_fmt_sf,formats_fill_fn_all,folders_Scaling_factors,Max_sf_ind,Min_sf_ind,nGM,nPop,F_l,F_u,tau_1,tau_2,cond,MaxGen,index,P_CF_0,P_CF_1,P_Par_F,P_Par_CR,comb,w,Sa_unsc_ave_suite,Sa_suite)
